  ...
  return (
    <>
      <div className=' px-16 gap-y-32 mt-16 flex-col flex items-center justify-center relative h-screen'>
        ...
        <div className='absolute top-1/12 right-2/12 bg-radial rounded-full from-red-900 from-0% to-dark to-70% size-120 z-0 opacity-75' />
        <div className='absolute bottom-1/12 left-2/12 bg-radial rounded-full from-yellow-900 from-0% to-dark to-70% size-120 z-0 opacity-75' />
      </div>
      {/* End Head */}
      {/* Start Section about */}
          ...
          <div className='grid grid-cols-2 grid-rows-4 gap-6 col-span-1 row-span-4'>
            ...
            <div className='col-span-2 row-start-3 bg-dark p-8 rounded-[2.5rem] border border-gray-dark z-10'>
              ...
              <p className='text-light text-xl font-mono leading-10 mb-0'>
                Node.Js / Spring Boot / ASP.NET / Prisma / MongoDB / PostgreSQL
                / MySQL
              </p>
            </div>
