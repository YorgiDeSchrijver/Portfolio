...
export default function About() {
  return (
    <div className='w-full h-full flex flex-col gap-y-16'>
      <section className='flex-col flex items-center justify-center relative h-screen w-full'>
        <div className='gap-y-16 flex-col flex z-10'>
          ...
          <div className='flex'>
            <p className='w-1/3 text-gray-light text-2xl font-sans font-normal'>
              ...
              currently getting an extra degree in IT.
            </p>
            <Textfit
              mode='single'
              max={4000}
        ...
        <div className='absolute top-1/12 left-2/12 bg-radial rounded-full from-blue-900 from-0% to-dark to-70% size-120 z-0 opacity-75' />
        <div className='absolute bottom-1/12 right-2/12 bg-radial rounded-full from-green-900 from-0% to-dark to-70% size-120 z-0 opacity-75' />
      </section>
      <section className='flex-col flex items-center justify-center relative h-full w-full'>
      ...
      <section className='flex-col flex items-center justify-center relative h-full w-full'>
        ...
        <div className='flex flex-col justify-center items-center border-b border-gray-dark'>
          {education.map((edu, index) => (
            <div
              key={index}
              className='grid grid-cols-6 gap-4 border-t border-gray-dark w-full px-4 py-4 z-10 hover:bg-light group'
            >
      ...
      <section className='flex-col flex items-center justify-center relative h-full w-full my-16 '>
        <div className='bg-light p-16 rounded-[2.5rem] border border-light text-center'>
          ...
          <p className='text-dark text-2xl font-sans leading-relaxed max-w-4xl mx-auto'>
            ...
            continuously learning new technologies. My small experience already has
