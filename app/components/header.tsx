...
export default function Header() {
  return (
    <header className='w-full py-2 transition-all duration-1000 fixed top-0 z-9999'>
      <div className='flex w-full justify-between items-center max-w-360 mx-auto px-4 md:px-8 xl:px-12 2xl:px-28'>
